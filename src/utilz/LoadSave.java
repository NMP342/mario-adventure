...
public class LoadSave {
    ...
    public static final String PLAYING_BG_IMG = "playing_bg_img_plus.png";
    ...
    public static final String SHOP_BUTTONS = "shop_button_atlas_plus.png";
    public static final String SHOP_BACKGROUND = "shop_background_plus.png";
    public static final String RED_POTION = "red_potion.png";
    public static final String GREEN_POTION = "green_potion.png";
    public static final String SILVER_COIN = "silver_coin.png";
    public static final String SILVER_COIN_ATLAS = "silver_coin_atlas.png";
    public static final String CANDLE_ATLAS = "candle_atlas.png";
    public static final String CANDLE_LIGHT_ATLAS = "candle_light_atlas.png";
    public static final String DEATH_BUTTON_ATLAS = "before_death_button.png";
